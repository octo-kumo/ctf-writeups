...
ai_summary: CTF challenge required reverse Polish notation (RPN) evaluation to decode an arithmetic expression using custom operators and flag manipulation
ai_tags:
  - rpn
  - arithmetics
  - custom-operators
